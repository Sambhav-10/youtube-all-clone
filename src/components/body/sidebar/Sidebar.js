...
const Sidebar = () => {
  ...
  return !isManuOpen ? null : (
    <div className='w-[200px] bg-green-300 h-[90vh] '>
        <section className='border '>
            ...
            <div className='flex items-center'>
                <img className=' w-1/4' src="https://cdn.icon-icons.com/icons2/3237/PNG/512/menu_youtube_social_media_subs_subscription_icon_197393.png" alt="" />
                <p>Subscriptions</p>
            </div>
        </section>
